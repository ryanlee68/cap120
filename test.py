...
def slot(further, col):
    if further:
        ...
        if col == 2:
            ...
            robot.jmove(rel=0,vel=vel,accel=accel,jerk=jerk,turn=turn,cont=cont,j0=89.4825,j1=18.5175,j2=-29.266,j3=12.7125,j4=-106.47)
            # robot.lmove(rel=1,vel=vel,accel=accel,jerk=jerk,turn=turn,cont=cont, y = 5)
        if col == 3:
        ...
        if col == 1:
            ...
            robot.jmove(rel=0,vel=vel,accel=accel,jerk=jerk,turn=turn,cont=cont,j0=88.38,j2=-99.7045,j3=-113.79375,j4=35.94375)
        ...
        if col == 2:
            ...
            robot.jmove(rel=0,vel=vel,accel=accel,jerk=jerk,turn=turn,cont=cont,j0=86.844375,j1=39.1995,j2=-102.4145,j3=-117.48375,j4=91.06875)
        if col == 3:
            pass
